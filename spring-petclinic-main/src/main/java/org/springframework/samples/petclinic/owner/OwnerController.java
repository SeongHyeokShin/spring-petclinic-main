...
//		Page<Owner> f_ownersResults = findPaginatedForOwnersFirstName(page, firstName);
//		if (f_ownersResults.isEmpty()) {
//			// no owners found
//			result.rejectValue("firstName", "notFound", "not found");
//			return "owners/findOwners";
//		}
//		else if (f_ownersResults.getTotalElements() == 1) {
//			// 1 owner found
//			owner = f_ownersResults.iterator().next();
//			return "redirect:/owners/" + owner.getId();
//		}
//		else {
//			// multiple owners found
//			firstName = owner.getFirstName();
//			return addPaginationModel(page, model, firstName, f_ownersResults);
//		}
	}
